      ...
      <div class = "login--container">
         <div class="text-center mt-24">
            <div class="flex items-center justify-center">
               <svg fill="none" viewBox="0 0 24 24" class="w-12 h-12 text-black" stroke="currentColor">
         ...
         <div class="flex justify-center my-2 mx-4 md:mx-0">
            <form class="w-full max-w-xl bg-white rounded-lg shadow-md p-6">
               <div class="flex flex-wrap -mx-3 mb-6">
                  ...
                  <div class="w-full md:w-full px-3 mb-6">
                     <button class="appearance-none block w-full bg-gray-100 text-gray-800 font-bold border border-gray-200 rounded-lg py-3 px-3 leading-tight hover:text-white hover:bg-black focus:outline-none focus:bg-white focus:border-gray-500" onClick={handleLoginClick}>Sign in</button>
                  </div>
